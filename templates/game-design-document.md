...
|--------------------------|-----------|----------------------------|--------|
| [e.g., "combo multiplier feeds score"] | `docs/gdd/score.md` | `combo_multiplier` output value | Data dependency |
| [e.g., "death triggers respawn"] | `docs/gdd/respawn.md` | Death state transition | State trigger |
| [e.g., "stamina gates dodge"] | `docs/gdd/stamina.md` | Stamina depletion rule | Rule dependency |
