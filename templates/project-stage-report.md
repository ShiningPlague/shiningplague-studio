...
- reverse-doc pass via the reverse-documentation templates (architecture-doc-from-code / design-doc-from-implementation / concept-doc-from-prototype) — [For which gap]
- `/architecture-decision` — [For which gap]
- `/sprint-plan` — [If production planning missing]
- `/retrospective` — [If approaching deadline]
- `/start` (Path D → /adopt) — [If new contributor joining]
