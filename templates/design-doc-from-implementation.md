...
- Run `/content-audit` + systems-designer balance pass on [specific aspect]
...
- [ ] **Balance pass**: `/content-audit` + systems-designer dispatch on progression curve
...
**Related Skills**:
- systems-designer dispatch — validate formulas and progression
- `/architecture-decision` — Document technical decisions
- `/code-review` — Ensure code matches clarified design

---

*Reverse-documented from implementation using the design-doc-from-implementation template*
