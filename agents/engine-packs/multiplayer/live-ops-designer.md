...
- Document the full cadence calendar in `docs/live-ops/content-calendar.md`
...
- Season documents go in `docs/live-ops/seasons/S[number]_[name].md`
...
- Document economy rules in `docs/live-ops/economy-rules.md`
...
- Document monetization ethics policy in `docs/live-ops/ethics-policy.md`

## Planning Documents
- `docs/live-ops/content-calendar.md` — Full cadence calendar
- `docs/live-ops/seasons/` — Per-season design documents
- `docs/live-ops/economy-rules.md` — Economy design and pricing
- `docs/live-ops/events/` — Per-event design documents
- `docs/live-ops/ethics-policy.md` — Monetization ethics guidelines
- `docs/live-ops/retention-strategy.md` — Retention mechanics and re-engagement
...
`docs/live-ops/ethics-policy.md`, and escalate to **creative-director** for a binding ruling
