...
1. **Create Failing Test Case**
   ...
   - Use the `test-driven-development (bundled)` skill for writing proper failing tests
...
- **verification-before-completion (bundled)** - Verify fix worked before claiming success
