...
- A manifest of all source directories: `src/`, `data/`, any config files
...
> "⛔ CRITICAL security findings must be resolved before any public release. Do not proceed to `/gate-check` (release gate) until these are addressed."
