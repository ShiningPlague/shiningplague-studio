...
metadata:
  ...
  enhancements:
    ...
    - Solo-dev context (no parallelism, data-driven fast paths)
    - 1-2 week step sizing
---

# Estimate

> 🌱 **ShiningPlague-adopted.** Originally Donchitos (barebones stub); battle-tested on a shipped Godot project. Upstream was a pointer-only file; this version is the full implementation — sub-task breakdown, complexity-based estimates, risk multipliers, solo-dev context.
...
- Each "step" should be 1-2 weeks max
